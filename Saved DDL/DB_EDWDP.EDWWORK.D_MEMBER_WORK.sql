...
GRANT SELECT ON TABLE EDWWORK.D_MEMBER_WORK TO USER SASBIPROD;

GRANT ALTER, DELETE, INDEX, INSERT, SELECT, UPDATE ON TABLE EDWWORK.D_MEMBER_WORK TO USER SASDIPROD;

GRANT SELECT ON TABLE EDWWORK.D_MEMBER_WORK TO USER SVC_BI_FEDDBUSER_PRD;

GRANT SELECT ON TABLE EDWWORK.D_MEMBER_WORK TO USER SVC_TBLADMIN_PRD;

GRANT SELECT ON TABLE EDWWORK.D_MEMBER_WORK TO GROUP DB2_MIS_MON;

GRANT SELECT ON TABLE EDWWORK.D_MEMBER_WORK TO GROUP MIS_DB_ACCESS_PROD_R;

GRANT ALTER, DELETE, INDEX, INSERT, SELECT, UPDATE ON TABLE EDWWORK.D_MEMBER_WORK TO GROUP MIS_DB_ACCESS_PROD_SYS;
