-- Step 1. Drop
DROP ALIAS BDL_ALIAS."Member Marketing Pref Mthly";

DROP ALIAS BDL_ALIAS."Member myHBF Interactions Mthly";

DROP ALIAS SASDIRLSE.DD_D_MEMBER_MASTER;

DROP VIEW BDL."Member myHBF Interactions Monthly";

DROP VIEW BDL."Member Marketing Preferences Monthly";

DROP VIEW BDL."Member Marketing Activities";

DROP TABLE DD.DD_D_MEMBER_MASTER;
...
GRANT SELECT ON TABLE DD.DD_D_MEMBER_MASTER TO USER SASDIDEV1;
...
AS
/* */
SELECT MEM.MMBR_NUM, CMNCN.CREATED_DT, CMNCN.CHAN_ID, CMNCN.CMPGN_ID, CMNCN.CMPGN_DESC, CMNCN.PROMOTION_NUM, CMNCN.PROMOTION_DESC, CMNCN.MMBR_AGE, MEM.GENDER_CDE, MEM.GEOTRIBE_SEGMENT, NULL, -- for region Address
 CONMEM.HI_PLCY_RLTNSHP_DESC, MEM.PRFRD_CONTACT_MTHD, MEM.DOC_CHNL, CMNCN.CMNCN_ACTIVITY_CNT FROM DD.DD_F_CMNCN_ACTIVITY CMNCN INNER JOIN DD.DD_D_MEMBER_MASTER MEM ON MEM.MMBR_NUM = CMNCN.MMBR_NUM AND CMNCN.CREATED_DT BETWEEN MEM.EFF_DT AND MEM.END_DT and mem.TEST_MMBR_FLG = 'N' LEFT OUTER JOIN DD.DD_D_EN_CONTACTABLE_MEMBER CONMEM ON CONMEM.MMBR_NUM = CMNCN.MMBR_NUM AND CMNCN.CREATED_DT BETWEEN CONMEM.EFF_DT AND CONMEM.END_DT
WITH NO ROW MOVEMENT;

GRANT SELECT ON BDL."Member Marketing Activities" TO USER SASBIRLSE;

GRANT SELECT ON BDL."Member Marketing Activities" TO USER SASDIDEV1;

GRANT SELECT ON BDL."Member Marketing Activities" TO USER SVC_BI_FEDDBUSER_RLS;

GRANT SELECT ON BDL."Member Marketing Activities" TO USER SVC_TBLADMIN_RLS;

GRANT SELECT ON BDL."Member Marketing Activities" TO GROUP DB2_MIS_MON;

GRANT SELECT ON BDL."Member Marketing Activities" TO GROUP EDW_SELF_SERVICE_R_RLS;

GRANT SELECT ON BDL."Member Marketing Activities" TO GROUP EDW_SELF_SERVICE_R_SYS;

GRANT SELECT ON BDL."Member Marketing Activities" TO GROUP MIS_DB_ACCESS_RLSE_R;

GRANT SELECT ON BDL."Member Marketing Activities" TO GROUP MIS_DB_ACCESS_RLSE_SYS;
...
GRANT SELECT ON BDL."Member Marketing Preferences Monthly" TO USER SASBIRLSE;

GRANT SELECT ON BDL."Member Marketing Preferences Monthly" TO USER SASDIDEV1;

GRANT SELECT ON BDL."Member Marketing Preferences Monthly" TO USER SVC_BI_FEDDBUSER_RLS;

GRANT SELECT ON BDL."Member Marketing Preferences Monthly" TO USER SVC_TBLADMIN_RLS;

GRANT SELECT ON BDL."Member Marketing Preferences Monthly" TO GROUP DB2_MIS_MON;

GRANT SELECT ON BDL."Member Marketing Preferences Monthly" TO GROUP EDW_SELF_SERVICE_R_RLS;

GRANT SELECT ON BDL."Member Marketing Preferences Monthly" TO GROUP MIS_DB_ACCESS_RLSE_R;

GRANT SELECT ON BDL."Member Marketing Preferences Monthly" TO GROUP MIS_DB_ACCESS_RLSE_SYS;
...
AS
SELECT 
  MONTHLY_FACT.REPORTING_YR_MTH, 
  MONTHLY_FACT.REPORTING_DT,
  MEM.MMBR_NUM,
  MONTHLY_FACT.MMBR_AGE, 
  NULL, -- Age Group
  MEM.GENDER_CDE,
  MEM.GEOTRIBE_SEGMENT,
  NULL, -- placehodler for address region
  CONMEM.HI_PLCY_RLTNSHP_DESC,  
  MEM.MMBR_LATEST_SENSITIVITY_FLG,
  CONMEM.MMBR_CONTACTABLE_FLG,   
  CONMEM.MMBR_MARKETABLE_FLG,
  MONTHLY_FACT.MMBR_MYHBF_RGSTRTN_IND,
  MONTHLY_FACT.MMBR_MYHBF_ACTIVE_IND, 
  MONTHLY_FACT.MMBR_MYHBF_TERMS_ACCEPTED_FLG, 
  DATE(MONTHLY_FACT.MMBR_MYHBF_TERMS_ACCEPTED_TS), 
  TIME(MONTHLY_FACT.MMBR_MYHBF_TERMS_ACCEPTED_TS),  
  DATE(MEM.MMBR_MYHBF_FIRST_LOGIN_TS), 
  TIME(MEM.MMBR_MYHBF_FIRST_LOGIN_TS), 
  DATE(MONTHLY_FACT.LAST_LOGIN_DT), 
  TIME(MONTHLY_FACT.LAST_LOGIN_DT), 
  MONTHLY_FACT.LOGIN_ACTIVITIES_CNT,  
...
FROM 
DD.DD_MF_SUM_MYHBF_PORTAL MONTHLY_FACT
INNER JOIN DD.DD_D_MEMBER_MASTER MEM 
  ON MEM.MMBR_NUM = MONTHLY_FACT.MMBR_NUM 
AND MONTHLY_FACT.REPORTING_DT BETWEEN MEM.EFF_DT AND MEM.END_DT 
LEFT OUTER JOIN DD.DD_D_EN_CONTACTABLE_MEMBER CONMEM 
  ON CONMEM.MMBR_NUM = MONTHLY_FACT.MMBR_NUM 
AND MONTHLY_FACT.REPORTING_DT BETWEEN CONMEM.EFF_DT AND CONMEM.END_DT
WITH NO ROW MOVEMENT;

SET SCHEMA = PYR;

GRANT SELECT ON BDL."Member myHBF Interactions Monthly" TO USER SASBIRLSE;

SET SCHEMA = GZD;

GRANT SELECT ON BDL."Member myHBF Interactions Monthly" TO USER SASDIDEV1;

GRANT SELECT ON BDL."Member myHBF Interactions Monthly" TO USER SVC_BI_FEDDBUSER_RLS;
...
GRANT SELECT ON BDL."Member myHBF Interactions Monthly" TO USER SVC_TBLADMIN_RLS;
...
GRANT SELECT ON BDL."Member myHBF Interactions Monthly" TO GROUP EDW_SELF_SERVICE_R_RLS;

SET SCHEMA = PYR;

GRANT SELECT ON BDL."Member myHBF Interactions Monthly" TO GROUP EDW_SELF_SERVICE_R_RLS;

GRANT SELECT ON BDL."Member myHBF Interactions Monthly" TO GROUP MIS_DB_ACCESS_RLSE_R;

GRANT SELECT ON BDL."Member myHBF Interactions Monthly" TO GROUP MIS_DB_ACCESS_RLSE_SYS;

CREATE OR REPLACE ALIAS SASDIRLSE.DD_D_MEMBER_MASTER
  FOR DD.DD_D_MEMBER_MASTER;
