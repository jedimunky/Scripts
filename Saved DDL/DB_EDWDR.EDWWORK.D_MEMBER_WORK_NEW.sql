DROP TABLE EDWWORK.D_MEMBER_WORK_NEW;
...
GRANT SELECT ON TABLE EDWWORK.D_MEMBER_WORK_NEW TO USER SASDIDEV1;

GRANT SELECT ON TABLE EDWWORK.D_MEMBER_WORK_NEW TO USER SVC_BI_FEDDBUSER_RLS;

GRANT SELECT ON TABLE EDWWORK.D_MEMBER_WORK_NEW TO USER SVC_TBLADMIN_RLS;

GRANT SELECT ON TABLE EDWWORK.D_MEMBER_WORK_NEW TO GROUP DB2_MIS_MON;

GRANT SELECT ON TABLE EDWWORK.D_MEMBER_WORK_NEW TO GROUP MIS_DB_ACCESS_RLSE_R;

GRANT ALTER, DELETE, INDEX, INSERT, SELECT, UPDATE ON TABLE EDWWORK.D_MEMBER_WORK_NEW TO GROUP MIS_DB_ACCESS_RLSE_SYS;
