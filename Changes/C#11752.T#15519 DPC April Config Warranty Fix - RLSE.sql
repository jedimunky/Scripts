SELECT *
FROM RLSEC.TW112_HEALTHRULE
WHERE     LST_UPD_USERID = 'FIX'
      AND LST_UPD_TERMINAL = 'BTCH'
      AND DATE (LST_UPD_TIMESTAMP) = CURRENT DATE;

INSERT INTO RLSEC.TW112_HEALTHRULE
   (SELECT 'FIX',
           'BTCH',
           CURRENT TIMESTAMP,
           HR1.OVERALL_FED,
           ...
           HR1.WAIVE_EXCESS_5,
           HR1.WAIVE_EXCESS_6
    FROM RLSEC.TW112_HEALTHRULE HR1, RLSEC.TW101_PRODDEFN PD
    WHERE     PD.PRODUCT = HR1.PRODUCT
          ...
          AND PD.PRODUCT NOT IN ('GS1',
                                 ...
                                 '02T',
                                 '03T')
          AND PD.PRODUCT NOT LIKE 'H%'
          AND PD.PRODUCT NOT LIKE '07%'
