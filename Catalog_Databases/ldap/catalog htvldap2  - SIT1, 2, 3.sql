...
-- SIT1
uncatalog db LSIT1INT;
uncatalog db LSIT1EXT;

uncatalog system odbc data source LSIT1INT;
uncatalog system odbc data source LSIT1EXT;

uncatalog node LSIT1INT;
uncatalog node LSIT1EXT;
